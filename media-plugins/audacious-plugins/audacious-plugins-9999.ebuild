...
MY_P="${P/_/-}"
S="${WORKDIR}/${MY_P}"
DESCRIPTION="Audacious Player - Your music, your way, no exceptions (live)"
HOMEPAGE="http://audacious-media-player.org/"
EGIT_SRC_URI="git://github.com/audacious-media-player/audacious-plugins.git"
...
lame libnotify libsamplerate lirc midi mms mp3 nls pulseaudio scrobbler sdl sid sndfile vorbis wavpack gtk qt"
