...
# $Header: /var/cvsroot/gentoo-x86/media-video/ffmpeg/ffmpeg-1.0.8.ebuild,v 1.13 2014/05/15 17:11:09 ulm Exp $
...
IUSE="
	...
	vaapi vdpau vorbis vpx X x264 xvid +zlib tpe
	"
...
src_configure() {
	...
	use tpe && echo "Fixup: Changing TMPDIR to ${S}/tmpdir to satisfy grsecurity." && TMPDIR=${S}/tmpdir && mkdir ${TMPDIR} && chmod 700 ${TMPDIR}
